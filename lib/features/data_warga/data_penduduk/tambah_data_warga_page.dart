...
class _TambahDataWargaPageState extends State<TambahDataWargaPage> {
  ...
  void dispose() {
    ...
    _peranKeluargaController.dispose();
  ...
  Future<void> _submitData() async {
    ...
    try {
      // Buat WargaModel dari form data
      final newWarga = WargaModel(
        ...
        birthDate: _selectedTanggalLahir,
        ...
        statusPenduduk: _selectedStatusWarga ?? 'Aktif',
        statusHidup: 'Hidup',
        peranKeluarga: _peranKeluargaController.text.trim(),
        ...
        kewarganegaraan: _kewarganegaraanController.text.trim().isEmpty
            ? 'Indonesia'
            : _kewarganegaraanController.text.trim(),
        ...
        if (success) {
          ...
          showDialog(
            ...
            builder: (context) => AlertDialog(
              ...
              content: Text(
                'Data warga "${_namaController.text}" berhasil ditambahkan ke Firestore.',
                style: GoogleFonts.poppins(),
              ),
              actions: [
                TextButton(
          ...
          _showErrorSnackbar(provider.errorMessage ?? 'Gagal menyimpan data warga');
        }
      }
    } catch (e) {
      setState(() => _isLoading = false);
